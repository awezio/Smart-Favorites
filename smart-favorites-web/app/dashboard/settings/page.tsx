      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="space-y-2">
            ...
            <Input readOnly value={embeddingModel} />
          </div>
          <div className="grid gap-2 md:grid-cols-2">
            <label className="flex cursor-pointer items-start gap-3 rounded-lg border p-3">
              <input
                ...
                value="local"
                checked={embeddingPreference === "local"}
                onChange={() => setEmbeddingPreference("local")}
                className="mt-1"
              />
              <span>
                <span className="block font-medium">{t.localXenovaTitle}</span>
                <span className="block text-sm text-muted-foreground">
                  {t.localXenovaDescription}
                </span>
              </span>
            </label>
            <label className="flex cursor-pointer items-start gap-3 rounded-lg border p-3">
              <input
                ...
                name="embeddingPreference"
                value="openai"
                checked={embeddingPreference === "openai"}
                onChange={() => setEmbeddingPreference("openai")}
                className="mt-1"
              />
              <span>
                <span className="block font-medium">{t.openaiEmbeddingsTitle}</span>
                <span className="block text-sm text-muted-foreground">
                  {t.openaiEmbeddingsDescription}
                </span>
              </span>
            </label>
          </div>
